...
function runDailyGeneration() {
    ...
    cron.schedule("10 19 * * *", () => __awaiter(this, void 0, void 0, function* () {
        console.log("Running generateDummyProducts...");
        yield generateDummyProduct(1); // Adjust the number of dummy products as needed
...
function sync() {
    ...
    cron.schedule("*/15 * * * *", () => __awaiter(this, void 0, void 0, function* () {
        ...
        if (isSyncInProgress) {
            console.log("Sync is already in progress. Terminating new sync initiation.");
            return;
        }
        // Set flag to indicate sync is in progress
        isSyncInProgress = true;
        console.log("Sync Initiated");
        yield synchronizeProduct(); // Adjust the number of dummy products as needed
